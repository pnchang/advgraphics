...
LRESULT CALLBACK WinProc(HWND hWnd, unsigned uMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   case WM_KEYDOWN:         // Is A Key Being Held Down?
      ...
      case '1':
         {
            lpD3DDevice8->SetTextureStageState( 0, D3DTSS_MAGFILTER, 
               D3DTEXF_POINT );
            lpD3DDevice8->SetTextureStageState( 0, D3DTSS_MINFILTER, 
               D3DTEXF_POINT );
            break;
         }   
      ...
      case 'B':
         {   
            DWORD val;
            lpD3DDevice8->GetRenderState(D3DRS_ALPHABLENDENABLE, &val);
...
{ 
   ...
   // default blending
   lpD3DDevice8->SetTextureStageState( 0, D3DTSS_MAGFILTER, D3DTEXF_ANISOTROPIC );
   lpD3DDevice8->SetTextureStageState( 0, D3DTSS_MINFILTER, D3DTEXF_ANISOTROPIC );
...
void render()
{
   ...
   if (val)
   {
      ...
      lpD3DDevice8->SetRenderState( D3DRS_AMBIENT, 0x00404040 );
