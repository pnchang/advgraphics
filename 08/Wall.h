...
{
public:
   Wall(LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex, LPDIRECT3DTEXTURE9 lightmap);   // default constructor
...
private:
   ...
   LPDIRECT3DTEXTURE9        m_texture;    // primary texture..
   LPDIRECT3DTEXTURE9        m_lightMap;   // 2nd texture..
